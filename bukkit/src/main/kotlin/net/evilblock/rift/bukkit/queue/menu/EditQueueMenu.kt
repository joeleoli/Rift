...
import net.evilblock.rift.bukkit.server.menu.SelectRouteMenu
...
class EditQueueMenu(private val queue: Queue) : Menu() {
    ...
    private inner class EditPollingRateButton : Button() {
        ...
        override fun getDescription(player: Player): List<String> {
            ...
            description.add("")
            description.add("${ChatColor.GRAY}Current polling rate: ${NumberUtils.format(queue.pollingRate)}")
            description.add("")
    ...
    private inner class EditPollingSizeButton : Button() {
        ...
        override fun getDescription(player: Player): List<String> {
            ...
            description.add("")
            description.add("${ChatColor.GRAY}Current polling size: ${NumberUtils.format(queue.pollingSize)}")
            description.add("")
